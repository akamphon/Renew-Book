...
#+LATEX_HEADER: \usepackage[bibstyle=numeric,citestyle=numeric,backend=biber,language=english,autolang=other]{biblatex}
...
- $AST$ :: เวลาสุริยคติปรากฏ (ใช้คำนวณตำแหน่งดวงอาทิตย์)
- $LT$ :: เวลาท้องถิ่น (local time) (เวลาในนาฬิกา)
- $ET$ :: สมการเวลา (ความแตกต่างระหว่างเวลาสุริยคติฉลี่ยกับเวลาสุริยคติปรากฏ)
- $SL$ :: เส้นแวงมาตรฐาน (where your timezone is based)
- $LL$ :: เส้นแวงท้องถิ่น (where you actually are)
