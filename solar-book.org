...
สิ่งแรกที่จะต้องใช้ในการคำนวนตำแหน่งดวงอาทิตย์คือเวลา 
...
\begin{align}
  A = \left\{
  \begin{array}{ll}
    \sin^{-1} -\frac{\cos \delta \sin h}{\cos \alpha} + 2\pi; & \sin \delta - \sin \alpha \sin L \geqslant 0 \\
    \pi - \sin^{-1} -\frac{\cos \delta \sin h}{\cos \alpha}; & \sin \delta - \sin \alpha \sin L < 0
  \end{array} \right.
\end{align}
...
\begin{align*}
  \sin A &= -\frac{\cos \delta \sin h}{\cos \alpha} \\
         ...
         &= 0.977 \\
  \sin^{-1} (0.977) &= 77.7^{\circ}
\end{align*}

ตรวจสอบค่าเงื่อนไขของมุมอาซิมุธ $\sin \delta - \sin \alpha \sin L$ ได้ $\sin -14.3 - \sin -9.44 \sin 16.4 = -0.2$
\begin{align*}
  A &= \pi - 77.7^{\circ} = 102.3^{\circ}
\end{align*}

$A = 102.3^{\circ}$ means the sun is to the east, and a little to the south (winter time)
...
Determine solar incident angle on solar panel with a tilt angle of 15$^{\circ}$ and azimuth angle of 180$^{\circ}$ in ขอนแก่น on Feb 12, Thailand.
...
*** Example: Solar Irradiation on PV in ขอนแก่น

Estimate beam, diffuse, and reflected components of solar radiation on PV tilted 30 degree to the south at ขอนแก่น (16.4N, 102.8E) from 10:00-11:00 on Feb 12. Here $I$ = 1.2 MJ/m^2 and $\rho_g$ = 0.6.

*** Solution: Solar Irradiation on PV in ขอนแก่น
