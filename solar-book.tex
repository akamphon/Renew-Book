...
ซึ่งระบบเซลล์แสงอาทิตย์สามารถเขียนแทนได้ด้วยวงจรเทียบเท่าได้โดยไดโอดและความต้านทานภายในดังรูปที่ \ref{org45b539f}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \node at (4,1.5) {$V_L$};
  \end{tikzpicture}
\caption{\label{org45b539f}วงจรเทียบเท่าของเซลล์แสงอาทิตย์}
\end{figure}
...
เมื่อแทนสมการ \ref{eq:org4619f18} ลงในสมการ
\ref{eq:org01de674} จะได้สมการ
...
\subsection{Solution}
\label{sec:orgacf60e4}
จากสมการ \ref{eq:orge538950} เราจะสามารถคำนวณหาค่าความต่างศักย์ที่สร้างกระแสไฟฟ้าสูงสุด
\(P_{\max P}\) ได้ดังนี้
...
\subsection{การถ่ายเทความร้อนจากแผงรับสู่ท่อ}
\label{sec:org46bd4be}
...
\caption{ภาพภาคตัดขวางของแผงรับแสงอาทิตย์และท่อเพื่อใช้ในการพิจารณาการถ่ายเทความร้อน}
\end{figure}
...
\begin{description}
\item[{\(S\)}] พลังงานแสงอาทิตย์ที่แผงรับดูดซึมได้ = \(\alpha I_t\)
\end{description}
...
\begin{enumerate}
\item ความสมมาตรที่ตำแหน่งกลางท่อ ดังนั้นความชันของสมการอุณหภูมิ-ระยะ \(x\) ควรเป็น 0: \(\dfrac{dT}{dx} \Bigr|_{x=0} = 0\)
\item อุณหภูมิที่ฐานของแผงรับ: \(T \bigr|_{x=(W-D)/2} = T_b\)
\end{enumerate}
...
จะเห็นได้ว่า \(q_u^{\prime}\) หรือพลังงานทั้งหมดที่แผงรับไว้ได้เท่ากับพลังงานแสงอาทิตย์ที่ตกกระทบลบด้วยความร้อนที่สูญเสียไป

\section{Useful Heat Gain Transfer to Fluid}
\label{sec:orgccd9331}
\begin{itemize}
...
ซึ่งหากเราสมมติว่าค่าสัมประสิทธิ์นี้เป็นอิสระจากอุณหภูมิ จะสามารถเขียนสมการ \ref{eq:org8fa761b} ใหม่ได้ว่า
...
อย่างไรก็ดี ประสิทธิภาพของเทอร์โมอิเล็กทริกจากวัสดุหนึ่งๆนั้นไม่ได้ขึ้นอยู่กับค่าสัมประสิทธิ์ซีเบ็กเพียงอย่างเดียว เนื่องจากลักษณะการทำงานและการต่อเชื่อมของเทอร์โมอิเล็กทริกกับวงจรไฟฟ้านั้นเป็นเหมือนแบตเตอรี่ชนิดหนึ่ง ซึ่งสามารถเขียนอธิบายเป็นวงจรได้ดังรูปที่ \ref{org617267d}
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
\caption{\label{org617267d}ภาพวงจรแสดงคุณสมบัติของเครื่องผลิตไฟฟ้าเทอร์โมอิเล็กทริก}
\end{figure}
...
ซึ่งเรียกว่า figure of merit และแทนค่าเข้าในสมการ \ref{eq:org49f9e1c} จะสามารถเขียนสมการประสิทธิภาพของเทอร์โมอิเลกทริกได้ว่า
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
\caption{\label{org8d2f25c}ประสิทธิภาพความร้อนของ TEG เทียบกับประสิทธิภาพคาร์โนต์}
\end{figure}

จากรูป \ref{org8d2f25c} จะเห็นได้ว่าแม้ที่ \(ZT = 2\) ประสิทธิภาพของเทอร์โมอิเลกทริกยังมีค่าอยู่ที่ประมาณ 10\% - 20\% ของประสิทธิภาพคาร์โนต์ ซึ่งนับว่ายังต่ำมากเมื่อเทียบกับเครื่องยนต์สันดาปภายในทั่วไปซึ่งมีประสิทธิภาพประมาณ 50\% - 80\% ของประสิทธิภาพคารโนต์

\section{{\bfseries\sffamily TODO} วัสดุเทอร์โมอิเลกทริก}
\label{sec:org3d5e69f}
จากสมการ \ref{eq:org7e570a3}
...
\label{sec:orgd31f11f}
\section{ปฏิกิริยาในเซลล์เชื้อเพลิง}
\label{sec:orgfa81053}
อันที่จริงแล้ว
...
\label{sec:org545188d}
\[ \ce{2H^+ + 2e^- + O2 -> H_2O}\]

\subsubsection{ปฏิกิริยาออกซิเดชัน}
\label{sec:org62c01c3}
\[ \ce{H2 -> 2H^+ + 2e^-}\]
...
ซึ่งมีค่าเท่ากันกับพลังงานไฟฟ้าสูงสุดที่เซลล์เชื้อเพลิงสามารถผลิตได้ในสมการ \ref{eq:org6c38b5f} ซึ่งพลังงานอิสระของกิบส์ที่เปลี่ยนแปลงในปฏิกิริยาใดๆสามารถเขียนเป็นสมการได้ดังนี้
...
จากสมการ \ref{eq:org7390357} หากพิจารณาปฏิกิริยาของสารที่เป็นแก๊สอุดมคติ จะสามารถเขียนความสัมพันธ์ทางอุณหพลศาสตร์ได้ดังนี้
...
\(H_0\) และ \(G_0\) ได้จากตารางที่ \ref{tab:org5ef6764}

\section{พลังงานอิสระของกิบส์ที่เปลี่ยนแปลงในปฏิกิริยาเคมี}
\label{sec:org10a585e}
ในปฏิกิริยาเคมี
...
\begin{table}[htbp]
\caption{\label{tab:org5ef6764}เอนทาลปีของการก่อเกิด (\(H_0\)) และพลังงานอิสระของกิบส์ (\(G_0\)) ของสารต่างๆ}
\centering
\begin{tabular}{lrr}
\toprule
...
\label{sec:org1ef895b}
จากสมการ \ref{eq:orgace8004} ศักย์ไฟฟ้าที่เซลล์เชื้อเพลิงสามารถสร้างได้เท่ากับพลังานอิสระที่เปลี่ยนไปหารด้วยประจุที่มีการแลกเปลี่ยน ดังนั้นหากทุกๆโมเลกุลของสารตั้งต้นมีการแลกอิเลกตรอน \(n\) ตัว สมการแสดงศักย์ไฟฟ้าต่อ 1 mol ของสารตั้งต้นจะเป็น
...
สมการ \ref{eq:org34ba386} นี้ถูกตั้งชื่อตามผู้ค้นพบว่า \textbf{สมการเนิร์นสท์ (Nernst Equation)}

\section{ประสิทธิภาพของเซลล์เชื้อเพลิง}
\label{sec:org4fe451f}
...
เมื่อแทนสมการ \ref{eq:orgefb75de} ลงในสมการ \ref{eq:orgf4e07da} จะได้สมการแสดงกำลังของลมที่ความเร็ว \(v\)
...
\begin{figure}[h]
   \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
\caption{\label{org86b02ed}ประสิทธิภาพของกังหันลมแรงยกที่อัตราส่วนความเร็วต่างๆ จะเห็นได้ว่าค่า \(\lambda\) ที่เหมาะสมที่สุดอยู่ที่ราว 67 ซึ่งให้ค่าสัมประสิทธิ์กำลังที่สูงถึง 889!}
\end{figure}
...
\begin{figure*}
  ...
  \begin{tikzpicture}[>=latex]
    ...
    \draw [->, thick] (den) -- (bio);
  \end{tikzpicture}
\caption{\label{org1a4ca01}กระบวนการผลิตไบโอเอทานอลจากน้ำตาลและแป้ง (วาดใหม่โดยได้รับอนุญาตจาก \citeprocitem{4}{[4]})}
\end{figure*}
...
\begin{figure*}
  ...
  \begin{tikzpicture}[>=latex]
    ...
    \draw [->, thick] (eth) -- (2nd);
  \end{tikzpicture}
\caption{\label{orgc259364}กระบวนการผลิตไบโอเอทานอลจากเซลลูโลส (วาดใหม่โดยได้รับอนุญาตจาก \citeprocitem{4}{[4]})}
\end{figure*}

\section{ความแตกต่างระหว่างเอทานอลรุ่นที่ 1 และรุ่นที่ 2}
\label{sec:orge693344}
...
\begin{figure*}
  ...
  \end{tikzpicture}
\caption{\label{org10f279f}กระบวนการผลิตไบโอดีเซล (วาดใหม่โดยได้รับอนุญาตจาก \citeprocitem{4}{[4]})}
\end{figure*}
...
\label{sec:org16cac2c}

ในระหว่างการเติมประจุ วัสดุที่เป็นขั้วบวกจะถูกออกซิไดซ์และให้อิเลกตรอน ส่วนวัสดุที่เป็นขั้วลบจะถูกรีดิวซ์และรับอิเลกตรอน \citeprocitem{6}{[6]} อิเลกตรอนที่เกิดจากปฏิกิริยานี้ทำให้เกิดการไหลของกระแสเมื่อต่อให้ครบวงจร สำหรับอิเลกโทรไลต์ที่อยู่ในแบตเตอรี่อาจเป็นได้ทั้งตัวนำกระแสระหว่างขั้ว (อย่างเช่นในกรณีของแบตเตอรี่ลิเทียม-ไออน) หรืออาจะเป็นหนึ่งในสารตั้งต้นที่ทำให้เกิดปฏิกิริยารีดอกซ์ขึ้น (เช่นกรณีของแบตเตอรี่ตะกั่ว-กรด)

\subsection{{\bfseries\sffamily TODO} แบตเตอรี่ตะกั่ว-กรด}
\label{sec:org10b4e8c}
...
\label{sec:org38e4eb4}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./pictures/battery-energy-density-comparison.png}
\caption{\label{fig:orgc282cb3}แผนภูมิเปรียบเทียบพลังงานจำเพาะและความหนาแน่นพลังงานของแบตเตอรี่ทุติยภูมิ}
\end{figure}

\section{ล้อตุนกำลัง}
\label{sec:org2d252e9}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
\caption{\label{org57923a1}Historical and projected transportation fuel cell system cost}
\end{figure}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
\caption{\label{org580a757}Historical and projected transportation fuel cell system cost}
\end{figure}

\section{ต้นทุนการผลิตไฟฟ้าพลังงานลม}
\label{sec:org8c04816}
...
\begin{figure}[h]
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
\caption{\label{org21e4b09}แผนภูมิเปรียบเทียบต้นทุนตลอดการใช้งานของโรงงานผลิตไฟฟ้าพลังงานลมแบบบนพิ้นดินกับแบบนอกชายฝั่ง}
\end{figure}

\section{การจำลองแบบต้นทุนการผลิตพลังงาน}
\label{sec:orgd8f933c}
...
\caption{\label{fig:org31a2d88}Earthship Brighton, UK}
\end{figure}

\section{ชุมชนที่ยั่งยืน}
\label{sec:orgd539595}
...
\label{sec:org0fc7aaa}
\subsubsection{ข้อมูลเบื้องต้น}
\label{sec:org9641ef4}
...
\label{sec:orgf3a465f}

\backmatter

\chapter{บรรณานุกรม}
\label{sec:org920f617}
